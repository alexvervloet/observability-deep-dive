...
climbs past 100. Why so *huge* — is a z of 120 a bug?

<details><summary>▸ Answer</summary>

Not a bug. Cost per request is an extremely *stable* baseline metric — its day-to-day
...
Real. 0.615 + 0.089 = 0.704, still well below the 0.79 baseline — the drop clears
...
Because normal p95 is already ~400ms — the static threshold is below the healthy
...
SHAP/LIME explain a *tabular* model's prediction in terms of its input features — an
